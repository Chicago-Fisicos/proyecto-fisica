...
DATA_CSV = 'data/chipi.csv'
INPUT_VIDEO = "videos/chipi-input.MOV"
OUTPUT_VIDEO_RAW = "videos/chipi-output-raw.mp4"
OUTPUT_VIDEO_CODEC_H264 = "videos/chipi-output-h264.mp4"
